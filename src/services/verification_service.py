...
from src.schemas import OCRResult, TamperingResult, FaceVerificationResult, RiskScoreResult
...
class VerificationService:
    ...
    async def verify(self, document_bytes: bytes, selfie_bytes: bytes = None):
        # 1. OCR Extraction
